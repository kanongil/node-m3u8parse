...
exports = module.exports = function (input, options = {}, cb) {
    ...
    const ParseExt = function (cmd, arg) {
        ...
        if (cmd in extensions) {
            ...
            if (!extObj.vendor) {
                extObj.vendor = new internals.Map();
            }
...
exports.M3U8Playlist = class {
    ...
    constructor(obj) {
        ...
        if (obj.vendor) {
            this.vendor = new internals.Map();

            if (obj.vendor instanceof Map) {
                for (const [entry, value] of obj.vendor) {
                    this.vendor.set(entry, Clone(value));
                }
            }
            else {
